...
const V='arkan-v107-1182'; /* dynamic OCR confidence + MULTICAIXA-ATM const V='arkan-v106-1181'; /* zero-duplicate guarantee: DB unique constraints + ref-based batch dedup + 409 handling */ BANCO SOL templates → clear receipts read 100% */
