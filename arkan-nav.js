...
(function () {
  ...
  .ark-app{display:flex;align-items:center;gap:13px;padding:15px;border-radius:16px;text-decoration:none;
    ...
    color:var(--ark-txt,#102A43);transition:transform .18s,border-color .18s,box-shadow .18s}
  .ark-app:hover{transform:translateY(-3px);border-color:var(--ark-violet,#0058D9);box-shadow:0 18px 40px -20px rgba(0,86,214,.18)}
  ...
  .ark-app-tx i{font-style:normal;font-size:12px;color:var(--ark-txt-2,#486581)}
  /* launcher */
