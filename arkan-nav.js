...
(function () {
  ...
  if (path === 'settle-v2.html' || path === 'settlement.html' || path === 'compare.html' || path === 'dues.html' || path === 'admin.html' || path === 'rates-admin.html') isOwner = true; /* صفحات مالك مغلقة أصلًا بالبوابة */
