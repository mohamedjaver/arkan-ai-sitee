...
"موريتانيا · أنغولا · الصين":{fr:"Mauritanie · Angola · Chine",pt:"Mauritânia · Angola · China"},
"بثقة المؤسسات":{fr:"avec la confiance des institutions",pt:"com a confiança das instituições"},
"ابدأ التحويل الآن":{fr:"Commencer le transfert",pt:"Iniciar transferência"},
"دقيقة سعر مثبّت عند التأكيد":{fr:"min. taux garanti à la confirmation",pt:"min. taxa garantida na confirmação"},
"زمن التنفيذ":{fr:"Délai d'exécution",pt:"Tempo de execução"},
"دقائق":{fr:"Minutes",pt:"Minutos"},
"تسوية مستمرة":{fr:"Règlement continu",pt:"Liquidação contínua"},
"الأسعار":{fr:"Taux",pt:"Taxas"},
"التحويل":{fr:"Transfert",pt:"Transferência"},
"الدعم":{fr:"Assistance",pt:"Apoio"},
"المنصة":{fr:"Plateforme",pt:"Plataforma"},
"تسجيل الدخول":{fr:"Connexion",pt:"Entrar"},
"احسب المبلغ الذي يستلمه المستفيد بسعر اليوم — بشفافية كاملة قبل الطلب.":{fr:"Calculez ce que reçoit le bénéficiaire au taux du jour — en toute transparence avant la demande.",pt:"Calcule o que o beneficiário recebe à taxa de hoje — com total transparência antes do pedido."},
"تبديل العملتين":{fr:"Inverser les devises",pt:"Inverter as moedas"},
"السعر مثبّت 30 دقيقة بعد تأكيد الطلب":{fr:"Taux garanti 30 minutes après confirmation",pt:"Taxa garantida 30 minutos após a confirmação"},
"سعر الصرف المطبق: 1":{fr:"Taux appliqué : 1",pt:"Taxa aplicada: 1"},
...
"تشفير بنكي وتوثيق على مستوى المؤسسات المالية.":{fr:"Chiffrement bancaire et authentification au niveau des institutions financières.",pt:"Encriptação bancária e autenticação ao nível das instituições financeiras."},
"أقل رسوم":{fr:"Frais réduits",pt:"Taxas reduzidas"},
"نسبة تنافسية تصل إلى 0.5% على التحويلات الدولية.":{fr:"Un taux compétitif jusqu'à 0,5% sur les transferts internationaux.",pt:"Uma taxa competitiva até 0,5% nas transferências internacionais."},
"تغطية عالمية":{fr:"Couverture mondiale",pt:"Cobertura global"},
"دعم أكثر من 50 عملة وتحويل لأكثر من 180 دولة.":{fr:"Plus de 50 devises et des transferts vers plus de 180 pays.",pt:"Mais de 50 moedas e transferências para mais de 180 países."},
"ارفع الفاتورة — صورة أو PDF":{fr:"Chargez la facture — image ou PDF",pt:"Carregue a fatura — imagem ou PDF"},
"جارٍ قراءة الفاتورة… قد تستغرق 20 ثانية":{fr:"Lecture de la facture… jusqu'à 20 secondes",pt:"A ler a fatura… até 20 segundos"},
"أرسل تفاصيل تحويلك — نرد بعرض السعر والتأكيد خلال دقائق.":{fr:"Envoyez les détails de votre transfert — devis et confirmation en quelques minutes.",pt:"Envie os detalhes da sua transferência — cotação e confirmação em minutos."},
...
"مثال: محمد — 36295050":{fr:"Ex. : Mohamed — 36295050",pt:"Ex.: Mohamed — 36295050"},
"منصة مؤسسية لصرف العملات الأجنبية وتسديد فواتير الموردين الدوليين بين موريتانيا وأنغولا والصين.":{fr:"Plateforme institutionnelle de change et de règlement des factures fournisseurs entre la Mauritanie, l'Angola et la Chine.",pt:"Plataforma institucional de câmbio e pagamento de faturas de fornecedores entre a Mauritânia, Angola e China."},
"ARKAN Rates © 2026 — منصة التحويلات المالية الذكية":{fr:"ARKAN Rates © 2026 — Plateforme de transferts financiers intelligents",pt:"ARKAN Rates © 2026 — Plataforma de transferências financeiras inteligentes"},
"ARKAN Rates — صرف العملات وتسديد فواتير الموردين":{fr:"ARKAN Rates — Change & règlement des factures fournisseurs",pt:"ARKAN Rates — Câmbio & pagamento de faturas de fornecedores"},
"تحويلات دولية بأقل تكلفة، مع شفافية كاملة في كل معاملة.":{fr:"Des transferts internationaux au moindre coût, avec une transparence totale sur chaque opération.",pt:"Transferências internacionais ao menor custo, com total transparência em cada operação."},
